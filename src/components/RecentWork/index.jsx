...
return (
    (<div
        className="max-w-7xl relative mx-auto py-10 md:py-10 px-4 w-full  left-0 top-0">
        <h1 className="text-2xl md:text-7xl font-bold text-black">
            Our Recent Work <br /> Gallery
        </h1>
        <p className="max-w-2xl text-base md:text-xl mt-8 text-black">
            We create stunning murals that elevate brand promotions and product visibility.
            Our team of talented artists is dedicated to transforming spaces with captivating artwork.
        </p>
    </div>)
);
};
