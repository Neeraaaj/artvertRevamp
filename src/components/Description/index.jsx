    ...
    return (
        <div ref={description} className={styles.description}>
            <div className={styles.body}>
                ...
                <motion.p variants={opacity} animate={isInView ? "open" : "closed"}>Our team’s passion for art, creativity, and engagement uniquely positions us in the mural design landscape, enabling us to help brands connect with their audiences in vibrant and impactful ways.</motion.p>
