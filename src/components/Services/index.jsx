...
export const Services = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="max-w-[30ch] font-extralight text-xl text-red-500 text-right">
      ...
      >
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12 text-center md:text-start">
          <Image
            src="https://images.squarespace-cdn.com/content/v1/5e8902081e8c3436e9de3130/d19790c7-490a-4751-9fb2-199b3e3f2412/8U7A0015+%281%29+%281%29.jpg"
            alt="people"
            width={288}
            height={96}
          ...
          <h4 className="capitalize text-4xl lg:text-6xl 2xl:text-8xl font-thin">
            <b className="font-extrabold text-orange-500 hover:text-green-500">
              Unique
            </b>{" "}
            Ideas
          </h4>
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12 text-center md:text-start">
          <h4 className="capitalize text-4xl lg:text-6xl 2xl:text-8xl font-thin">
            <b className="font-extrabold text-orange-600 hover:text-green-500">
              For Your
            </b>{" "}
            Business
          </h4>
